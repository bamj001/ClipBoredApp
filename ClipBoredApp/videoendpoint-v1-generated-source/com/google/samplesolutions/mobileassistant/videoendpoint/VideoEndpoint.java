...
package com.google.samplesolutions.mobileassistant.videoendpoint;

/**
 * Service definition for Videoendpoint (v1).
 *
 * <p>
 * This is an API
 * </p>
 ...
 *
 * <p>
 * This service uses {@link VideoendpointRequestInitializer} to initialize
...
public class VideoEndpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
	...
	static {
		com.google.api.client.util.Preconditions.checkState(
				...
				"You are currently running with version %s of google-api-client. "
						...
						+ "1.15.0-rc of the videoendpoint library.",
	 ...
	 * @since 1.7
	 */
	public static final String DEFAULT_SERVICE_PATH = "videoendpoint/v1/";
	 ...
	 * @since 1.7
	 */
	public VideoEndpoint(com.google.api.client.http.HttpTransport transport,
	 ...
	 *
	 * This request holds the parameters needed by the the videoendpoint server.
	 * After setting any optional parameters, call the
	 * {@link GetVideo#execute()} method to invoke the remote operation.
	 *
	 * @param id
	 * @return the request
	 */
	...
	public class GetVideo
			extends VideoEndpointRequest<com.google.samplesolutions.mobileassistant.videoendpoint.model.Video> {
		 ...
		 * Create a request for the method "getVideo".
		 *
		 * This request holds the parameters needed by the the videoendpoint
		 * server. After setting any optional parameters, call the
		 * {@link GetVideo#execute()} method to invoke the remote operation.
		 * <p>
		 * {@link GetVideo#initialize(com.google.api.client.googleapis.services.AbstractGoogleClientRequest)}
		...
		protected GetVideo(java.lang.String id) {
			super(VideoEndpoint.this, "GET", REST_PATH, null,
					com.google.samplesolutions.mobileassistant.videoendpoint.model.Video.class);
	 ...
	 * This request holds the parameters needed by the the videoendpoint server.
	 * After setting any optional parameters, call the
	 * {@link InsertVideo#execute()} method to invoke the remote operation.
	 *
	 * @param content
	 *            the
	 *            {@link com.google.samplesolutions.mobileassistant.videoendpoint.model.Video}
	 * @return the request
	 */
	public InsertVideo insertVideo(com.google.samplesolutions.mobileassistant.videoendpoint.model.Video content)
			throws java.io.IOException {
	...
	public class InsertVideo
		 ...
		 * {@link InsertVideo#execute()} method to invoke the remote operation.
		 * <p>
		 * {@link InsertVideo#initialize(com.google.api.client.googleapis.services.AbstractGoogleClientRequest)}
		 * must be called to initialize this instance immediately after invoking
		 * the constructor.
		 * </p>
		 *
		 ...
		 * @since 1.13
		 */
		protected InsertVideo(com.google.samplesolutions.mobileassistant.videoendpoint.model.Video content) {
			super(VideoEndpoint.this, "POST", REST_PATH, content,
					com.google.samplesolutions.mobileassistant.videoendpoint.model.Video.class);
		}
	 ...
	 * This request holds the parameters needed by the the videoendpoint server.
	 * After setting any optional parameters, call the
	 * {@link ListVideo#execute()} method to invoke the remote operation.
	 *
	 * @return the request
	 */
	...
	public class ListVideo extends
			VideoEndpointRequest<com.google.samplesolutions.mobileassistant.videoendpoint.model.CollectionResponseVideo> {
		 ...
		 * {@link ListVideo#execute()} method to invoke the remote operation.
		 * <p>
		 * {@link ListVideo#initialize(com.google.api.client.googleapis.services.AbstractGoogleClientRequest)}
		 * must be called to initialize this instance immediately after invoking
		 * the constructor.
		 * </p>
		 *
		...
		protected ListVideo() {
			super(VideoEndpoint.this, "GET", REST_PATH, null,
					com.google.samplesolutions.mobileassistant.videoendpoint.model.CollectionResponseVideo.class);
		}
	...
	/**
	 * Create a request for the method "listVideo_category".
	 *
	 * This request holds the parameters needed by the the videoendpoint server.
	 * After setting any optional parameters, call the
	 * {@link ListVideoCategory#execute()} method to invoke the remote
	 * operation.
	 *
	 * @param category
	 * @return the request
	 */
	public ListVideoCategory listVideoCategory(java.lang.String category) throws java.io.IOException {
		ListVideoCategory result = new ListVideoCategory(category);
		initialize(result);
		return result;
	}

	public class ListVideoCategory extends
			VideoEndpointRequest<com.google.samplesolutions.mobileassistant.videoendpoint.model.CollectionResponseVideo> {

		private static final String REST_PATH = "listVid_category";
		 ...
		 * operation.
		 * <p>
		 * {@link ListVideoCategory#initialize(com.google.api.client.googleapis.services.Ab stractGoogleClientRequest)}
		 * must be called to initialize this instance immediately after invoking
		 * the constructor.
		 * </p>
		 *
		 ...
		 * @since 1.13
		 */
		protected ListVideoCategory(java.lang.String category) {
			super(VideoEndpoint.this, "GET", REST_PATH, null,
					com.google.samplesolutions.mobileassistant.videoendpoint.model.CollectionResponseVideo.class);
			this.category = com.google.api.client.util.Preconditions.checkNotNull(category,
					"Required parameter category must be specified.");
		}
		...
		@Override
		public ListVideoCategory setAlt(java.lang.String alt) {
			return (ListVideoCategory) super.setAlt(alt);
		}

		@Override
		public ListVideoCategory setFields(java.lang.String fields) {
			return (ListVideoCategory) super.setFields(fields);
		}

		@Override
		public ListVideoCategory setKey(java.lang.String key) {
			return (ListVideoCategory) super.setKey(key);
		}

		@Override
		public ListVideoCategory setOauthToken(java.lang.String oauthToken) {
			return (ListVideoCategory) super.setOauthToken(oauthToken);
		}

		@Override
		public ListVideoCategory setPrettyPrint(java.lang.Boolean prettyPrint) {
			return (ListVideoCategory) super.setPrettyPrint(prettyPrint);
		}

		@Override
		public ListVideoCategory setQuotaUser(java.lang.String quotaUser) {
			return (ListVideoCategory) super.setQuotaUser(quotaUser);
		}

		@Override
		public ListVideoCategory setUserIp(java.lang.String userIp) {
			return (ListVideoCategory) super.setUserIp(userIp);
		}
		...
		public ListVideoCategory setCategory(java.lang.String category) {
		...
		public ListVideoCategory setCursor(java.lang.String cursor) {
			this.cursor = cursor;
			return this;
		}
		...
		public ListVideoCategory setLimit(java.lang.Integer limit) {
			this.limit = limit;
			return this;
		}

		@Override
		public ListVideoCategory set(String parameterName, Object value) {
			return (ListVideoCategory) super.set(parameterName, value);
		}
	}
	 ...
	 * This request holds the parameters needed by the the videoendpoint server.
	 * After setting any optional parameters, call the
	 * {@link RemoveVideo#execute()} method to invoke the remote operation.
	 *
	 * @param id
	 * @return the request
	 */
	...
	public class RemoveVideo extends VideoEndpointRequest<Void> {
		 ...
		 * {@link RemoveVideo#execute()} method to invoke the remote operation.
		 * <p>
		 * {@link RemoveVideo#initialize(com.google.api.client.googleapis.services.AbstractGoogleClientRequest)}
		 * must be called to initialize this instance immediately after invoking
		 * the constructor.
		 * </p>
		 *
	 ...
	 * This request holds the parameters needed by the the videoendpoint server.
	 * After setting any optional parameters, call the
	 * {@link UpdateVideo#execute()} method to invoke the remote operation.
	 *
	 * @param content
	 *            the
	 *            {@link com.google.samplesolutions.mobileassistant.videoendpoint.model.Video}
	 * @return the request
	 */
	public UpdateVideo updateVideo(com.google.samplesolutions.mobileassistant.videoendpoint.model.Video content)
			throws java.io.IOException {
	...
	public class UpdateVideo
		 ...
		 * {@link UpdateVideo#execute()} method to invoke the remote operation.
		 * <p>
		 * {@link UpdateVideo#initialize(com.google.api.client.googleapis.services.AbstractGoogleClientRequest)}
		 * must be called to initialize this instance immediately after invoking
		 * the constructor.
		 * </p>
		 *
		 ...
		 * @since 1.13
		 */
		protected UpdateVideo(com.google.samplesolutions.mobileassistant.videoendpoint.model.Video content) {
			super(VideoEndpoint.this, "PUT", REST_PATH, content,
					com.google.samplesolutions.mobileassistant.videoendpoint.model.Video.class);
		}
